...
export default function StratRoulette() {
  ...
  return isMobile ? (
    <>
      <div className="bg-popclr text-gray-900 outline outline-outlineclr max-h-full h-full m-5 p-5 flex-row overflow-hidden">
        <div className="w-full">
          ...
          <div className="text-white w-full h-full overflow-hidden">
            <div className="console-container flex flex-col h-5/6 bg-black rounded-lg border border-gray-700 shadow-lg">
        ...
        <div className="w-full justify-center p-5">
          <div className="flex justify-center">
            <input
              ...
              className="h-9 text-center w-54 mx-5 rounded-lg mb-5"
